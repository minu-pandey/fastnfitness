...
///cmt set    public static String SETTINGS = "Settings";
 ...
 ///   private MusicController musicController = new MusicController(this);
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     /// cmt set       if (mpSettingFrag == null) mpSettingFrag = SettingsFragment.newInstance(SETTINGS, 8);
      //      if (mpAboutFrag == null) mpAboutFrag = AboutFragment.newInstance(ABOUT, 6);
       ...
       ///cmt set     mpSettingFrag = (SettingsFragment) getSupportFragmentManager().getFragment(savedInstanceState, SETTINGS);
  ...
  ////      if (getSettingsFragment().isAdded())
       ///cmt set     getSupportFragmentManager().putFragment(outState, SETTINGS, mpSettingFrag);
 ...
 /***  lets see  private void exportDatabase() {
   ...
   ///             return true;
    ...
    private void showFragment(String pFragmentName, boolean addToBackStack) {
      ...
      ///cmt set  } else if (pFragmentName.equals(SETTINGS)) {
      ///cmt set      ft.replace(R.id.fragment_container, getSettingsFragment(), SETTINGS);
    ...
    public void setCurrentProfil(Profile newProfil) {
        ...
        //dont know  FragmentManager and    FragmentTransaction    showFragment(WEIGHT);    // rafraichit le fragment courant
                FragmentManager fragmentManager = getSupportFragmentManager();
                FragmentTransaction ft=fragmentManager.beginTransaction();
                showFragment(WEIGHT);
...
/////        if (mpSettingFrag == null)
       ///cmt set     mpSettingFrag = (SettingsFragment) getSupportFragmentManager().findFragmentByTag(SETTINGS);
    ///cmt set    if (mpSettingFrag == null) mpSettingFrag = SettingsFragment.newInstance(SETTINGS, 8);
